 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zb(t,e,n){let r=1,i=null,s=null,o=!1,l=0;function u(){return l===2}let c=!1;function d(...V){c||(c=!0,e.apply(null,V))}function p(V){i=setTimeout(()=>{i=null,t(E,u())},V)}function m(){s&&clearTimeout(s)}function E(V,...A){if(c){m();return}if(V){m(),d.call(null,V,...A);return}if(u()||o){m(),d.call(null,V,...A);return}r<64&&(r*=2);let S;l===1?(l=2,S=0):S=(r+Math.random())*1e3,p(S)}let P=!1;function x(V){P||(P=!0,m(),!c&&(i!==null?(V||(l=2),clearTimeout(i),p(0)):V||(l=1)))}return p(0),s=setTimeout(()=>{o=!0,x(!0)},n),x}function eD(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
